...
let AppComponent = class AppComponent {
    constructor(router, tiposService) {
        this.router = router;
...
GuiaItemComponent.ctorParameters = () => [
...
let DashboardComponent = class DashboardComponent extends _base_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(router, errorService, toast, guiasService, activatedRoute) {
    ...
    ngOnInit() {
        this.guias$ = this.activatedRoute.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(params => params['searchParam']), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(searchParam => this.guiasService.buscarGuias(searchParam)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["catchError"])(error => {
...
let DetailsComponent = class DetailsComponent extends _base_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    ...
    ngOnInit() {
        this.guia$ = this.activatedRoute.params
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(params => params['nombreGuia']), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(nombre => this.guiasService.buscarGuiaPorTitulo(nombre)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(guia => this.obtenerMultimedia(guia.formularios)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(error => {
            this.handleException(error);
...
let SearchComponent = class SearchComponent extends _base_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
...
let GuiasService = class GuiasService {
    constructor(http) {
        ...
        this.buscarGuiasPorTipo = (tipo) => {
            return this.http.get(this.url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatAll"])());
        };
        ...
        this.buscarGuiaPorTitulo = (titulo) => {
            return this.http.getResource(`${this.url}/titulo`, titulo).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatAll"])());
        };
    }
};
